<template>
  <div>
    ...
    <div class="relative mt-1 rounded-md shadow-sm">
      <input @keyup.enter="submitForm" style="min-width: 20rem;" v-model.trim="movieName" type="text"
      ...
      <div class=" absolute inset-y-0 right-0 flex items-center pr-3">
        ...
        <svg @click="sumbitForm" v-if="!emptyStringOnSubmit" width="24" height="24" class="text-green-500 cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
...
<script>
  export default {
    ...
    methods:{
      submitForm(){
        this.movieName === '' ? this.emptyStringOnSubmit = true :  this.emptyStringOnSubmit = false;
      },
    }
  };
  </script>
